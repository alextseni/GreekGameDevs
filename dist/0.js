...
/***/ "./node_modules/css-loader/index.js?{\"sourceMap\":true,\"minimize\":{\"autoprefixer\":{\"add\":true,\"remove\":true,\"browsers\":[\"last 2 versions\"]},\"discardComments\":{\"removeAll\":true},\"discardUnused\":false,\"mergeIdents\":false,\"reduceIdents\":false,\"safe\":true,\"sourcemap\":true}}!./node_modules/sass-loader/lib/loader.js?{\"sourceMap\":true,\"includePaths\":[\"E:/Documents/Github/GGD/src/styles\"]}!./src/routes/Database/components/cards/Card.scss":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".info{position:relative;top:20px;min-width:40px!important;padding:0!important;display:-ms-flexbox;display:flex;-ms-flex-item-align:start;align-self:flex-start}.btnandcardGrid{max-width:375px}.btnandcardGrid,.btnandcardList{display:-ms-flexbox;display:flex;-ms-flex-pack:start;justify-content:flex-start;-ms-flex-direction:column;flex-direction:column;-ms-flex-align:center;align-items:center;width:100%;margin:0 10px}.btnandcardList{max-width:1000px}.cardContainer{width:100%;padding:10px;background-color:#f4f5f7!important;-ms-flex-align:end;align-items:flex-end}.header{-ms-flex-direction:column;flex-direction:column}.header,.logo{display:-ms-flexbox;display:flex}.logo{-ms-flex-direction:row;flex-direction:row;-ms-flex-align:center;align-items:center;width:100%;background-color:rgba(93,93,93,.06);padding:5px 5px 5px 10px;-ms-flex-wrap:wrap;flex-wrap:wrap;-ms-flex-pack:justify;justify-content:space-between}.itemButton{text-align:left}.dot{height:5px;width:5px;background-color:#777;border-radius:50%;display:inline-block;margin-bottom:2px}.logoGrid{-ms-flex-direction:column;flex-direction:column;-ms-flex-align:center;align-items:center;width:100%;background-color:rgba(93,93,93,.06);padding:10px;-ms-flex-wrap:wrap;flex-wrap:wrap}.logoGrid,.otherInfo{display:-ms-flexbox;display:flex}.otherInfo{margin-top:2px}.socialGrid{-ms-flex-pack:center;justify-content:center}.socialGrid,.socialList{-ms-flex-align:left;align-items:left;display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;-ms-flex-align:center;align-items:center}.contentGrid{-ms-flex-pack:center;justify-content:center}.contentGrid,.contentList{-ms-flex-wrap:wrap;flex-wrap:wrap;min-height:24px;height:auto;-ms-flex-align:center;align-items:center;display:-ms-flexbox;display:flex;background-color:rgba(93,93,93,.06)}.line{border:1px solid rgba(0,0,0,.1);height:30px;margin:5px 0}.title{display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column}.icon{background-position:50%;width:160px;height:76px;background-position:100%}.icon,.iconGrid{background-size:contain;background-repeat:no-repeat}.iconGrid{background-position:50%;width:100%;height:150px;margin-bottom:10px}.footer{-ms-flex-pack:justify;justify-content:space-between;margin-top:5px}.footer,.tags{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-ms-flex-wrap:wrap;flex-wrap:wrap}.tag{height:24px!important;margin-left:10px;margin-top:5px}", "", {"version":3,"sources":["E:/Documents/Github/GGD/src/routes/Database/components/cards/E:\\Documents\\Github\\GGD/src\\routes\\Database\\components\\cards\\Card.scss"],"names":[],"mappings":"AACA,MACE,kBAAkB,AAChB,SAAS,AACT,yBAA0B,AAC1B,oBAAqB,AACrB,oBAAa,AAAb,aAAa,AACb,0BAAsB,AAAtB,qBAAsB,CACzB,AACD,gBAKE,eAAgB,CAGjB,AAED,gCATE,oBAAa,AAAb,aAAa,AACb,oBAA2B,AAA3B,2BAA2B,AAC3B,0BAAsB,AAAtB,sBAAsB,AACtB,sBAAmB,AAAnB,mBAAmB,AAEnB,WAAW,AACT,aAAgB,CAWnB,AARD,gBAOE,gBAAiB,CAClB,AAED,eACA,WAAW,AACT,aAAa,AACb,mCAAoC,AACpC,mBAAqB,AAArB,oBAAqB,CACtB,AACD,QAEE,0BAAsB,AAAtB,qBAAsB,CACvB,AACD,cAHE,oBAAa,AAAb,YAAa,CAYd,AATD,MAEE,uBAAmB,AAAnB,mBAAmB,AACnB,sBAAmB,AAAnB,mBAAmB,AACnB,WAAW,AACX,oCAAoC,AACpC,yBAAyB,AACzB,mBAAe,AAAf,eAAe,AACf,sBAA8B,AAA9B,6BAA8B,CAC/B,AACD,YACE,eAAgB,CACjB,AACD,KACE,WAAW,AACX,UAAU,AACV,sBAAsB,AACtB,kBAAkB,AAClB,qBAAqB,AACrB,iBACF,CAAE,AAIF,UAEE,0BAAsB,AAAtB,sBAAsB,AACtB,sBAAmB,AAAnB,mBAAmB,AACnB,WAAW,AACX,oCAAoC,AACpC,aAAa,AACb,mBAAe,AAAf,cAAe,CAChB,AACD,qBARE,oBAAa,AAAb,YAAa,CAWd,AAHD,WAEE,cAAe,CAChB,AACD,YAKE,qBAAuB,AAAvB,sBAAuB,CACxB,AACD,wBANE,oBAAiB,AAAjB,iBAAiB,AACjB,oBAAa,AAAb,aAAa,AACb,mBAAe,AAAf,eAAe,AACf,sBAAmB,AAAnB,kBAAmB,CAQpB,AACD,aAKI,qBAAuB,AAAvB,sBAAuB,CAG1B,AACD,0BARE,mBAAe,AAAf,eAAe,AACf,gBAAgB,AAChB,YAAY,AACZ,sBAAmB,AAAnB,mBAAmB,AAEnB,oBAAa,AAAb,aAAa,AACb,mCAAoC,CASrC,AACD,MACE,gCAAgC,AAChC,YAAY,AACZ,YAAe,CAChB,AACD,OACE,oBAAa,AAAb,aAAa,AACb,0BAAsB,AAAtB,qBAAsB,CACvB,AACD,MAII,wBAA2B,AAE3B,YAAY,AAChB,YAAY,AACZ,wBAAyB,CAGxB,AACD,gBAVE,wBAAwB,AACtB,2BAA4B,CAkB/B,AATD,UAIE,wBAAwB,AAExB,WAAW,AACX,aAAa,AACb,kBAAmB,CACpB,AAUD,QAEA,sBAA8B,AAA9B,8BAA8B,AAE9B,cAAe,CAEd,AACD,cANE,oBAAa,AAAb,aAAa,AAEf,sBAAmB,AAAnB,mBAAmB,AAEnB,mBAAe,AAAf,cAAe,CAOd,AAED,KACE,sBAAuB,AACvB,iBAAiB,AACjB,cAAe,CAChB","file":"Card.scss","sourcesContent":["\r\n.info {\r\n  position: relative;\r\n    top: 20px;\r\n    min-width: 40px !important;\r\n    padding: 0 !important;\r\n    display: flex;\r\n    align-self: flex-start;\r\n}\r\n.btnandcardGrid {\r\n  display: flex;\r\n  justify-content: flex-start;\r\n  flex-direction: column;\r\n  align-items: center;\r\n  max-width: 375px;\r\n  width: 100%;\r\n    margin: 0px 10px;\r\n}\r\n\r\n.btnandcardList {\r\n  display: flex;\r\n  justify-content: flex-start;\r\n  flex-direction: column;\r\n  align-items: center;\r\n  width: 100%;\r\n    margin: 0px 10px;\r\n  max-width: 1000px;\r\n}\r\n\r\n.cardContainer {\r\nwidth: 100%;\r\n  padding: 10px;\r\n  background-color: #f4f5f7 !important;\r\n  align-items: flex-end;\r\n}\r\n.header {\r\n  display: flex;\r\n  flex-direction: column;\r\n}\r\n.logo {\r\n  display: flex;\r\n  flex-direction: row;\r\n  align-items: center;\r\n  width: 100%;\r\n  background-color: rgba(93,93,93,.06);\r\n  padding: 5px 5px 5px 10px;\r\n  flex-wrap: wrap;\r\n  justify-content: space-between;\r\n}\r\n.itemButton {\r\n  text-align: left;\r\n}\r\n.dot {\r\n  height: 5px;\r\n  width: 5px;\r\n  background-color: #777;\r\n  border-radius: 50%;\r\n  display: inline-block;\r\n  margin-bottom: 2px\r\n}\r\n.cardsContainer {\r\n\r\n}\r\n.logoGrid {\r\n  display: flex;\r\n  flex-direction: column;\r\n  align-items: center;\r\n  width: 100%;\r\n  background-color: rgba(93,93,93,.06);\r\n  padding: 10px;\r\n  flex-wrap: wrap;\r\n}\r\n.otherInfo {\r\n  display: flex;\r\n  margin-top: 2px;\r\n}\r\n.socialGrid {\r\n  align-items: left;\r\n  display: flex;\r\n  flex-wrap: wrap;\r\n  align-items: center;\r\n  justify-content: center;\r\n}\r\n.socialList {\r\n  align-items: left;\r\n  display: flex;\r\n  flex-wrap: wrap;\r\n  align-items: center;\r\n}\r\n.contentGrid {\r\n  flex-wrap: wrap;\r\n  min-height: 24px;\r\n  height: auto;\r\n  align-items: center;\r\n    justify-content: center;\r\n  display: flex;\r\n  background-color: rgba(93,93,93,.06);\r\n}\r\n.contentList {\r\n  flex-wrap: wrap;\r\n  min-height: 24px;\r\n  height: auto;\r\n  align-items: center;\r\n  display: flex;\r\n  background-color: rgba(93,93,93,.06);\r\n}\r\n.line {\r\n  border: 1px solid rgba(0,0,0,.1);\r\n  height: 30px;\r\n  margin: 5px 0px;\r\n}\r\n.title {\r\n  display: flex;\r\n  flex-direction: column;\r\n}\r\n.icon {\r\n  //    box-shadow: 0 0px 10px rgba(0, 0, 0, 0.3);\r\n  background-size: contain;\r\n    background-repeat: no-repeat;\r\n    background-position: center;\r\n//    background-color: rgba(255,255,255,0.67);\r\n    width: 160px;\r\nheight: 76px;\r\nbackground-position: 100%;\r\n//border: 1px solid rgba(0,0,0,0.64);\r\n//border-radius: 50%;\r\n}\r\n.iconGrid {\r\n//  box-shadow: 0 0px 10px rgba(0, 0, 0, 0.3);\r\n  background-size: contain;\r\n  background-repeat: no-repeat;\r\n  background-position: 50%;\r\n//  max-width: 150px;\r\n  width: 100%;\r\n  height: 150px;\r\n  margin-bottom: 10px;\r\n}\r\n// .icon:hover {\r\n//     transform:scale(3);\r\n//     position:relative;\r\n//     top:-25px;\r\n//     left:70px;\r\n//     box-shadow: 0 0px 0px rgba(0, 0, 0, 0) !important;\r\n//     z-index: 99;\r\n// }\r\n\r\n.footer {\r\n  display: flex;\r\njustify-content: space-between;\r\nalign-items: center;\r\nmargin-top: 5px;\r\nflex-wrap: wrap;\r\n}\r\n.tags {\r\n  display: flex;\r\n  align-items: center;\r\n  flex-wrap: wrap;\r\n//  justify-content: center;\r\n}\r\n\r\n.tag {\r\n  height: 24px !important;\r\n  margin-left: 10px;\r\n  margin-top: 5px;\r\n}\r\n"],"sourceRoot":""}]);
...
/***/ "./node_modules/css-loader/index.js?{\"sourceMap\":true,\"minimize\":{\"autoprefixer\":{\"add\":true,\"remove\":true,\"browsers\":[\"last 2 versions\"]},\"discardComments\":{\"removeAll\":true},\"discardUnused\":false,\"mergeIdents\":false,\"reduceIdents\":false,\"safe\":true,\"sourcemap\":true}}!./node_modules/sass-loader/lib/loader.js?{\"sourceMap\":true,\"includePaths\":[\"E:/Documents/Github/GGD/src/styles\"]}!./src/routes/Database/components/data-layout/dataLayout.scss":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".contentContainer{height:100%;overflow:auto;padding:25px 30px}.contentLoader{margin:40px}.containerGrid{display:-ms-flexbox;display:flex;-ms-flex-pack:start;justify-content:flex-start;-ms-flex-direction:row;flex-direction:row;-ms-flex-wrap:wrap;flex-wrap:wrap}.containerGrid>div,.containerGrid>div>div:first-child{display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-wrap:wrap;flex-wrap:wrap;width:100%;-ms-flex-pack:distribute;justify-content:space-around}.containerList{display:-ms-flexbox;display:flex;-ms-flex-pack:start;justify-content:flex-start;-ms-flex-direction:column;flex-direction:column;-ms-flex-wrap:wrap;flex-wrap:wrap}", "", {"version":3,"sources":["E:/Documents/Github/GGD/src/routes/Database/components/data-layout/E:\\Documents\\Github\\GGD/src\\routes\\Database\\components\\data-layout\\dataLayout.scss"],"names":[],"mappings":"AACA,kBACE,YAAW,AACX,cAAc,AACV,iBAAkB,CACvB,AAED,eACE,WAAY,CACb,AAED,eACE,oBAAa,AAAb,aAAa,AACb,oBAA2B,AAA3B,2BAA2B,AAC3B,uBAAmB,AAAnB,mBAAmB,AACnB,mBAAe,AAAf,cAAe,CAChB,AASD,sDANE,oBAAa,AAAb,aAAa,AACb,uBAAmB,AAAnB,mBAAmB,AACnB,mBAAe,AAAf,eAAe,AACf,WAAW,AACX,yBAA6B,AAA7B,4BAA6B,CAQ9B,AAED,eACE,oBAAa,AAAb,aAAa,AACb,oBAA2B,AAA3B,2BAA2B,AAC3B,0BAAsB,AAAtB,sBAAsB,AACtB,mBAAe,AAAf,cAAe,CAChB","file":"dataLayout.scss","sourcesContent":["\r\n.contentContainer {\r\n  height:100%;\r\n  overflow: auto;\r\n      padding: 25px 30px;\r\n}\r\n\r\n.contentLoader {\r\n  margin: 40px;\r\n}\r\n\r\n.containerGrid {\r\n  display: flex;\r\n  justify-content: flex-start;\r\n  flex-direction: row;\r\n  flex-wrap: wrap;\r\n}\r\n\r\n.containerGrid > div > div:first-child {\r\n  display: flex;\r\n  flex-direction: row;\r\n  flex-wrap: wrap;\r\n  width: 100%;\r\n  justify-content: space-around;\r\n}\r\n.containerGrid > div {\r\n  display: flex;\r\n  flex-direction: row;\r\n  flex-wrap: wrap;\r\n  width: 100%;\r\n  justify-content: space-around;\r\n}\r\n\r\n.containerList {\r\n  display: flex;\r\n  justify-content: flex-start;\r\n  flex-direction: column;\r\n  flex-wrap: wrap;\r\n}\r\n"],"sourceRoot":""}]);
...
/***/ "./node_modules/css-loader/index.js?{\"sourceMap\":true,\"minimize\":{\"autoprefixer\":{\"add\":true,\"remove\":true,\"browsers\":[\"last 2 versions\"]},\"discardComments\":{\"removeAll\":true},\"discardUnused\":false,\"mergeIdents\":false,\"reduceIdents\":false,\"safe\":true,\"sourcemap\":true}}!./node_modules/sass-loader/lib/loader.js?{\"sourceMap\":true,\"includePaths\":[\"E:/Documents/Github/GGD/src/styles\"]}!./src/routes/Database/components/filters/filters.scss":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".filtersContainer{display:-ms-flexbox;display:flex;-ms-flex-pack:justify;justify-content:space-between;-ms-flex-align:center;align-items:center}.form{margin:0 20px!important}.noDrawer{display:none}.mainFilters{-ms-flex-pack:center;justify-content:center}.filtersToolbar,.mainFilters{display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap}.filtersToolbar{-ms-flex-pack:justify;justify-content:space-between;width:100%;-ms-flex-align:center;align-items:center}.chip{margin:5px}.chip:hover{background-color:#eaeaea!important}.multiselect{max-width:240px;width:100%;margin:10px 5px 5px}.subfilters{min-height:84px;width:100%;display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap}.tools{position:fixed;bottom:20px;right:0}.drawerHandle{position:fixed;top:70px;left:4px;z-index:10000}.searchBar{height:36px!important;padding:5px 0 5px 10px!important;border:1px solid #d0d0d0!important;-ms-flex-direction:row!important;flex-direction:row!important}.searchBar,.searchInput{-ms-flex-align:center!important;align-items:center!important}.searchInput{display:-ms-flexbox!important;display:flex!important}.searchInput>input{padding:0}.searchInput>div{display:-ms-flexbox;display:flex}.drawerBox>div{overflow:visible;background-color:#b8dff1;padding-bottom:20px;padding-left:110px}@media (max-width:500px){.viewButton{display:none!important}}.drawerInner{-ms-flex-direction:row;flex-direction:row;display:-ms-flexbox;display:flex;-ms-flex-pack:justify;justify-content:space-between;-ms-flex-align:end;align-items:flex-end}.drawerHeader{height:30px}@media (max-width:640px){.filtersToolbar{-ms-flex-pack:center;justify-content:center;-ms-flex-align:center;align-items:center}}", "", {"version":3,"sources":["E:/Documents/Github/GGD/src/routes/Database/components/filters/E:\\Documents\\Github\\GGD/src\\routes\\Database\\components\\filters\\filters.scss"],"names":[],"mappings":"AACA,kBACE,oBAAa,AAAb,aAAa,AACb,sBAA8B,AAA9B,8BAA8B,AAChC,sBAAmB,AAAnB,kBAAmB,CAClB,AAED,MACE,uBAA2B,CAC5B,AACD,UACE,YAAa,CACd,AACD,aAEE,qBAAuB,AAAvB,sBAAuB,CAExB,AACD,6BAJE,oBAAa,AAAb,aAAa,AAEb,mBAAe,AAAf,cAAe,CAQhB,AAND,gBAEA,sBAA8B,AAA9B,8BAA8B,AAE9B,WAAW,AACX,sBAAmB,AAAnB,kBAAmB,CAClB,AACD,MACE,UAAW,CACZ,AAED,YACE,kCAAoC,CACrC,AACD,aACE,gBAAgB,AAChB,WAAW,AACX,mBAAoB,CACrB,AAED,YAEE,gBAAgB,AAChB,WAAW,AACX,oBAAa,AAAb,aAAa,AAEb,mBAAe,AAAf,cAAe,CAChB,AACD,OACE,eAAe,AACf,YAAY,AACZ,OAAQ,CACT,AACD,cACE,eAAe,AACf,SAAS,AACT,SAAS,AACT,aAAc,CACf,AACD,WACE,sBAAuB,AACvB,iCAAoC,AACpC,mCAAoC,AAEpC,iCAA8B,AAA9B,4BAA8B,CAC/B,AACD,wBAHE,gCAA8B,AAA9B,4BAA8B,CAM/B,AAHD,aACE,8BAAwB,AAAxB,sBAAwB,CAEzB,AACD,mBACA,SAAU,CACT,AACD,iBACE,oBAAa,AAAb,YAAa,CACd,AAED,eACE,iBAAiB,AACjB,yBAAyB,AACzB,oBAAoB,AACpB,kBAAmB,CACpB,AACD,yBACA,YACE,sBAAwB,CACzB,CAAA,AAED,aACE,uBAAmB,AAAnB,mBAAmB,AACjB,oBAAa,AAAb,aAAa,AACb,sBAA8B,AAA9B,8BAA8B,AAC9B,mBAAqB,AAArB,oBAAqB,CACxB,AACD,cACE,WAAY,CACb,AACD,yBACE,gBACA,qBAAuB,AAAvB,uBAAuB,AACvB,sBAAmB,AAAnB,kBAAmB,CAClB,CAAA","file":"filters.scss","sourcesContent":["\r\n.filtersContainer {\r\n  display: flex;\r\n  justify-content: space-between;\r\nalign-items: center;\r\n}\r\n\r\n.form {\r\n  margin: 0px 20px !important;\r\n}\r\n.noDrawer {\r\n  display: none;\r\n}\r\n.mainFilters {\r\n  display: flex;\r\n  justify-content: center;\r\n  flex-wrap: wrap;\r\n}\r\n.filtersToolbar {\r\n  display: flex;\r\njustify-content: space-between;\r\nflex-wrap: wrap;\r\nwidth: 100%;\r\nalign-items: center;\r\n}\r\n.chip {\r\n  margin: 5px;\r\n}\r\n\r\n.chip:hover {\r\n  background-color: #eaeaea !important;\r\n}\r\n.multiselect {\r\n  max-width: 240px;\r\n  width: 100%;\r\n  margin: 10px 5px 5px;\r\n}\r\n\r\n.subfilters {\r\n  //align-items: flex-end;\r\n  min-height: 84px;\r\n  width: 100%;\r\n  display: flex;\r\n//  justify-content: center;\r\n  flex-wrap: wrap;\r\n}\r\n.tools {\r\n  position: fixed;\r\n  bottom: 20px;\r\n  right: 0;\r\n}\r\n.drawerHandle {\r\n  position: fixed;\r\n  top: 70px;\r\n  left: 4px;\r\n  z-index: 10000;\r\n}\r\n.searchBar {\r\n  height: 36px !important;\r\n  padding: 5px 0px 5px 10px !important;\r\n  border: 1px solid #d0d0d0 !important;\r\n  align-items: center !important;\r\n  flex-direction: row !important;\r\n}\r\n.searchInput {\r\n  display: flex !important;\r\nalign-items: center !important;\r\n}\r\n.searchInput > input {\r\npadding: 0;\r\n}\r\n.searchInput > div {\r\n  display: flex;\r\n}\r\n\r\n.drawerBox > div {\r\n  overflow: visible;\r\n  background-color: #b8dff1;\r\n  padding-bottom: 20px;\r\n  padding-left: 110px;\r\n}\r\n@media (max-width: 500px) {\r\n.viewButton {\r\n  display: none !important;\r\n}\r\n}\r\n.drawerInner {\r\n  flex-direction: row;\r\n    display: flex;\r\n    justify-content: space-between;\r\n    align-items: flex-end;\r\n}\r\n.drawerHeader {\r\n  height: 30px;\r\n}\r\n@media (max-width: 640px) {\r\n  .filtersToolbar {\r\n  justify-content: center;\r\n  align-items: center;\r\n  }\r\n}\r\n"],"sourceRoot":""}]);
...
/***/ "./node_modules/css-loader/index.js?{\"sourceMap\":true,\"minimize\":{\"autoprefixer\":{\"add\":true,\"remove\":true,\"browsers\":[\"last 2 versions\"]},\"discardComments\":{\"removeAll\":true},\"discardUnused\":false,\"mergeIdents\":false,\"reduceIdents\":false,\"safe\":true,\"sourcemap\":true}}!./node_modules/sass-loader/lib/loader.js?{\"sourceMap\":true,\"includePaths\":[\"E:/Documents/Github/GGD/src/styles\"]}!./src/routes/Database/components/forms/form.scss":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".infoContainer{-ms-flex-align:center;align-items:center;padding:30px;font-size:22px;max-width:600px}.infoContainer,.infoForm{display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;width:100%}.infoForm{margin-top:20px;-ms-flex-align:left;align-items:left;max-width:500px}.formLabel{font-size:18px!important}.multiline>div{margin-top:20px!important;background-color:#f7f7f7}.popupStatus{position:absolute;-ms-flex-direction:column;flex-direction:column;display:-ms-flexbox;display:flex;-ms-flex-pack:center;justify-content:center;-ms-flex-align:center;align-items:center;width:100%;z-index:9;opacity:.8;height:100%;top:0;left:0}", "", {"version":3,"sources":["E:/Documents/Github/GGD/src/routes/Database/components/forms/E:\\Documents\\Github\\GGD/src\\routes\\Database\\components\\forms\\form.scss"],"names":[],"mappings":"AAAA,eAEE,sBAAmB,AAAnB,mBAAmB,AACnB,aAAa,AAEb,eAAe,AAEf,eAAgB,CACjB,AAED,yBATE,oBAAa,AAAb,aAAa,AAGb,0BAAsB,AAAtB,sBAAsB,AAEtB,UAAW,CAWZ,AAPD,UACE,gBAAgB,AAEhB,oBAAiB,AAAjB,iBAAiB,AAGjB,eAAgB,CACjB,AACD,WACE,wBAA0B,CAC3B,AACD,eACE,0BAA2B,AAC3B,wBAAyB,CAC1B,AAED,aACE,kBAAkB,AAClB,0BAAsB,AAAtB,sBAAsB,AACxB,oBAAa,AAAb,aAAa,AACb,qBAAuB,AAAvB,uBAAuB,AACvB,sBAAmB,AAAnB,mBAAmB,AACnB,WAAW,AACX,UAAU,AACV,WAAY,AACZ,YAAY,AACZ,MAAM,AACN,MAAO,CACN","file":"form.scss","sourcesContent":[".infoContainer {\r\n  display: flex;\r\n  align-items: center;\r\n  padding: 30px;\r\n  flex-direction: column;\r\n  font-size: 22px;\r\n  width: 100%;\r\n  max-width: 600px;\r\n}\r\n\r\n.infoForm {\r\n  margin-top: 20px;\r\n  display: flex;\r\n  align-items: left;\r\n  flex-direction: column;\r\n  width: 100%;\r\n  max-width: 500px;\r\n}\r\n.formLabel {\r\n  font-size: 18px !important;\r\n}\r\n.multiline > div {\r\n  margin-top: 20px !important;\r\n  background-color: #f7f7f7;\r\n}\r\n\r\n.popupStatus {\r\n  position: absolute;\r\n  flex-direction: column;\r\ndisplay: flex;\r\njustify-content: center;\r\nalign-items: center;\r\nwidth: 100%;\r\nz-index: 9;\r\nopacity: 0.8;\r\nheight: 100%;\r\ntop: 0;\r\nleft: 0;\r\n}\r\n"],"sourceRoot":""}]);
...
/***/ "./node_modules/css-loader/index.js?{\"sourceMap\":true,\"minimize\":{\"autoprefixer\":{\"add\":true,\"remove\":true,\"browsers\":[\"last 2 versions\"]},\"discardComments\":{\"removeAll\":true},\"discardUnused\":false,\"mergeIdents\":false,\"reduceIdents\":false,\"safe\":true,\"sourcemap\":true}}!./node_modules/sass-loader/lib/loader.js?{\"sourceMap\":true,\"includePaths\":[\"E:/Documents/Github/GGD/src/styles\"]}!./src/routes/Database/components/table/table.scss":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".tableWrapper{margin-top:20px;background-color:#f4f5f7!important;width:100%}.flexClass{display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap}.footerItem{margin-right:10px}", "", {"version":3,"sources":["E:/Documents/Github/GGD/src/routes/Database/components/table/E:\\Documents\\Github\\GGD/src\\routes\\Database\\components\\table\\table.scss"],"names":[],"mappings":"AAAA,cACE,gBAAgB,AAChB,mCAAoC,AACpC,UAAW,CACZ,AAED,WACI,oBAAa,AAAb,aAAa,AACb,mBAAe,AAAf,cAAe,CAClB,AAED,YACE,iBAAkB,CACnB","file":"table.scss","sourcesContent":[".tableWrapper {\r\n  margin-top: 20px;\r\n  background-color: #f4f5f7 !important;\r\n  width: 100%;\r\n}\r\n\r\n.flexClass {\r\n    display: flex;\r\n    flex-wrap: wrap;\r\n}\r\n\r\n.footerItem {\r\n  margin-right: 10px;\r\n}\r\n"],"sourceRoot":""}]);
...
var _propTypes = __webpack_require__("./node_modules/react-async-script/node_modules/prop-types/index.js");
...
/***/ "./node_modules/react-async-script/node_modules/fbjs/lib/emptyFunction.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/react-async-script/node_modules/fbjs/lib/invariant.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/react-async-script/node_modules/fbjs/lib/warning.js":
/***/ (function(module, exports, __webpack_require__) {
...
var emptyFunction = __webpack_require__("./node_modules/react-async-script/node_modules/fbjs/lib/emptyFunction.js");
...
/***/ "./node_modules/react-async-script/node_modules/prop-types/checkPropTypes.js":
/***/ (function(module, exports, __webpack_require__) {
...
if (true) {
  var invariant = __webpack_require__("./node_modules/react-async-script/node_modules/fbjs/lib/invariant.js");
  var warning = __webpack_require__("./node_modules/react-async-script/node_modules/fbjs/lib/warning.js");
  var ReactPropTypesSecret = __webpack_require__("./node_modules/react-async-script/node_modules/prop-types/lib/ReactPropTypesSecret.js");
...
/***/ "./node_modules/react-async-script/node_modules/prop-types/factoryWithTypeCheckers.js":
/***/ (function(module, exports, __webpack_require__) {
...
var ReactPropTypesSecret = __webpack_require__("./node_modules/react-async-script/node_modules/prop-types/lib/ReactPropTypesSecret.js");
var checkPropTypes = __webpack_require__("./node_modules/react-async-script/node_modules/prop-types/checkPropTypes.js");
...
/***/ "./node_modules/react-async-script/node_modules/prop-types/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
if (true) {
  ...
  module.exports = __webpack_require__("./node_modules/react-async-script/node_modules/prop-types/factoryWithTypeCheckers.js")(isValidElement, throwOnDirectAccess);
} else {
...
/***/ "./node_modules/react-async-script/node_modules/prop-types/lib/ReactPropTypesSecret.js":
/***/ (function(module, exports, __webpack_require__) {
...
var _propTypes = __webpack_require__("./node_modules/react-google-recaptcha/node_modules/prop-types/index.js");
...
/***/ "./node_modules/react-google-recaptcha/node_modules/fbjs/lib/emptyFunction.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/react-google-recaptcha/node_modules/fbjs/lib/invariant.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/react-google-recaptcha/node_modules/fbjs/lib/warning.js":
/***/ (function(module, exports, __webpack_require__) {
...
var emptyFunction = __webpack_require__("./node_modules/react-google-recaptcha/node_modules/fbjs/lib/emptyFunction.js");
...
/***/ "./node_modules/react-google-recaptcha/node_modules/prop-types/checkPropTypes.js":
/***/ (function(module, exports, __webpack_require__) {
...
if (true) {
  var invariant = __webpack_require__("./node_modules/react-google-recaptcha/node_modules/fbjs/lib/invariant.js");
  var warning = __webpack_require__("./node_modules/react-google-recaptcha/node_modules/fbjs/lib/warning.js");
  var ReactPropTypesSecret = __webpack_require__("./node_modules/react-google-recaptcha/node_modules/prop-types/lib/ReactPropTypesSecret.js");
  var loggedTypeFailures = {};
}
...
/***/ "./node_modules/react-google-recaptcha/node_modules/prop-types/factoryWithTypeCheckers.js":
/***/ (function(module, exports, __webpack_require__) {
...
var ReactPropTypesSecret = __webpack_require__("./node_modules/react-google-recaptcha/node_modules/prop-types/lib/ReactPropTypesSecret.js");
var checkPropTypes = __webpack_require__("./node_modules/react-google-recaptcha/node_modules/prop-types/checkPropTypes.js");
...
/***/ "./node_modules/react-google-recaptcha/node_modules/prop-types/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
if (true) {
  ...
  // http://fb.me/prop-types-in-prod
  var throwOnDirectAccess = true;
  module.exports = __webpack_require__("./node_modules/react-google-recaptcha/node_modules/prop-types/factoryWithTypeCheckers.js")(isValidElement, throwOnDirectAccess);
} else {
  // By explicitly using `prop-types` you are opting into new production behavior.
  // http://fb.me/prop-types-in-prod
  module.exports = require('./factoryWithThrowingShims')();
...
/***/ "./node_modules/react-google-recaptcha/node_modules/prop-types/lib/ReactPropTypesSecret.js":
/***/ (function(module, exports, __webpack_require__) {
...
var _propTypes = __webpack_require__("./node_modules/react-infinite-scroller/node_modules/prop-types/index.js");
...
/***/ "./node_modules/react-infinite-scroller/node_modules/fbjs/lib/emptyFunction.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/react-infinite-scroller/node_modules/fbjs/lib/invariant.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/react-infinite-scroller/node_modules/fbjs/lib/warning.js":
/***/ (function(module, exports, __webpack_require__) {
...
var emptyFunction = __webpack_require__("./node_modules/react-infinite-scroller/node_modules/fbjs/lib/emptyFunction.js");
...
/***/ "./node_modules/react-infinite-scroller/node_modules/prop-types/checkPropTypes.js":
/***/ (function(module, exports, __webpack_require__) {
...
if (true) {
  var invariant = __webpack_require__("./node_modules/react-infinite-scroller/node_modules/fbjs/lib/invariant.js");
  var warning = __webpack_require__("./node_modules/react-infinite-scroller/node_modules/fbjs/lib/warning.js");
  var ReactPropTypesSecret = __webpack_require__("./node_modules/react-infinite-scroller/node_modules/prop-types/lib/ReactPropTypesSecret.js");
  var loggedTypeFailures = {};
}
...
/***/ "./node_modules/react-infinite-scroller/node_modules/prop-types/factoryWithTypeCheckers.js":
/***/ (function(module, exports, __webpack_require__) {
...
var ReactPropTypesSecret = __webpack_require__("./node_modules/react-infinite-scroller/node_modules/prop-types/lib/ReactPropTypesSecret.js");
var checkPropTypes = __webpack_require__("./node_modules/react-infinite-scroller/node_modules/prop-types/checkPropTypes.js");
...
/***/ "./node_modules/react-infinite-scroller/node_modules/prop-types/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
if (true) {
  ...
  // http://fb.me/prop-types-in-prod
  var throwOnDirectAccess = true;
  module.exports = __webpack_require__("./node_modules/react-infinite-scroller/node_modules/prop-types/factoryWithTypeCheckers.js")(isValidElement, throwOnDirectAccess);
} else {
  // By explicitly using `prop-types` you are opting into new production behavior.
  // http://fb.me/prop-types-in-prod
  module.exports = require('./factoryWithThrowingShims')();
...
/***/ "./node_modules/react-infinite-scroller/node_modules/prop-types/lib/ReactPropTypesSecret.js":
/***/ (function(module, exports, __webpack_require__) {
...
var _propTypes = __webpack_require__("./node_modules/react-input-autosize/node_modules/prop-types/index.js");
...
/***/ "./node_modules/react-input-autosize/node_modules/fbjs/lib/emptyFunction.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/react-input-autosize/node_modules/fbjs/lib/invariant.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/react-input-autosize/node_modules/fbjs/lib/warning.js":
/***/ (function(module, exports, __webpack_require__) {
...
var emptyFunction = __webpack_require__("./node_modules/react-input-autosize/node_modules/fbjs/lib/emptyFunction.js");
...
if (true) {
  var invariant = __webpack_require__("./node_modules/react-input-autosize/node_modules/fbjs/lib/invariant.js");
  var warning = __webpack_require__("./node_modules/react-input-autosize/node_modules/fbjs/lib/warning.js");
  var ReactPropTypesSecret = __webpack_require__("./node_modules/react-input-autosize/node_modules/prop-types/lib/ReactPropTypesSecret.js");
  var loggedTypeFailures = {};
}
...
var ReactPropTypesSecret = __webpack_require__("./node_modules/react-input-autosize/node_modules/prop-types/lib/ReactPropTypesSecret.js");
var checkPropTypes = __webpack_require__("./node_modules/react-input-autosize/node_modules/prop-types/checkPropTypes.js");
...
if (true) {
  ...
  // http://fb.me/prop-types-in-prod
  var throwOnDirectAccess = true;
  module.exports = __webpack_require__("./node_modules/react-input-autosize/node_modules/prop-types/factoryWithTypeCheckers.js")(isValidElement, throwOnDirectAccess);
} else {
  // By explicitly using `prop-types` you are opting into new production behavior.
  // http://fb.me/prop-types-in-prod
  module.exports = require('./factoryWithThrowingShims')();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__("./node_modules/react-select/node_modules/prop-types/index.js");
...
/***/ "./node_modules/react-select/node_modules/fbjs/lib/emptyFunction.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/react-select/node_modules/fbjs/lib/invariant.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/react-select/node_modules/fbjs/lib/warning.js":
/***/ (function(module, exports, __webpack_require__) {
...
var emptyFunction = __webpack_require__("./node_modules/react-select/node_modules/fbjs/lib/emptyFunction.js");
...
if (true) {
  var invariant = __webpack_require__("./node_modules/react-select/node_modules/fbjs/lib/invariant.js");
  var warning = __webpack_require__("./node_modules/react-select/node_modules/fbjs/lib/warning.js");
  var ReactPropTypesSecret = __webpack_require__("./node_modules/react-select/node_modules/prop-types/lib/ReactPropTypesSecret.js");
  var loggedTypeFailures = {};
}
...
var ReactPropTypesSecret = __webpack_require__("./node_modules/react-select/node_modules/prop-types/lib/ReactPropTypesSecret.js");
var checkPropTypes = __webpack_require__("./node_modules/react-select/node_modules/prop-types/checkPropTypes.js");
...
if (true) {
  ...
  // http://fb.me/prop-types-in-prod
  var throwOnDirectAccess = true;
  module.exports = __webpack_require__("./node_modules/react-select/node_modules/prop-types/factoryWithTypeCheckers.js")(isValidElement, throwOnDirectAccess);
} else {
  // By explicitly using `prop-types` you are opting into new production behavior.
  // http://fb.me/prop-types-in-prod
  module.exports = require('./factoryWithThrowingShims')();
...
/***/ "./src/routes/Database/Tools/components/Tools.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_routes_Database_components__ = __webpack_require__("./src/routes/Database/components/index.js");
...
var Tools = function (_Component) {
  __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_inherits___default()(Tools, _Component);

  function Tools(props) {
    __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, Tools);

    var _this = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_possibleConstructorReturn___default()(this, (Tools.__proto__ || Object.getPrototypeOf(Tools)).call(this, props));
  ...
  __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(Tools, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          ...
          initializeState = _props.initializeState,
          view = _props.view,
      ...
      return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_routes_Database_components__["a" /* DataLayout */], {
...
Tools.propTypes = {
  filters: __WEBPACK_IMPORTED_MODULE_5_prop_types___default.a.object.isRequired,
  updateFilter: __WEBPACK_IMPORTED_MODULE_5_prop_types___default.a.func.isRequired,
  resetAllFilters: __WEBPACK_IMPORTED_MODULE_5_prop_types___default.a.func.isRequired,
  view: __WEBPACK_IMPORTED_MODULE_5_prop_types___default.a.string.isRequired,
  changeView: __WEBPACK_IMPORTED_MODULE_5_prop_types___default.a.func.isRequired,
  currentData: __WEBPACK_IMPORTED_MODULE_5_prop_types___default.a.array.isRequired,
  updateData: __WEBPACK_IMPORTED_MODULE_5_prop_types___default.a.func.isRequired
};
...
/***/ "./src/routes/Database/VideoGames/components/VideoGames.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var VideoGames = function (_Component) {
  __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_inherits___default()(VideoGames, _Component);

  function VideoGames(props) {
    __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, VideoGames);

    var _this = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_possibleConstructorReturn___default()(this, (VideoGames.__proto__ || Object.getPrototypeOf(VideoGames)).call(this, props));
  ...
  __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(VideoGames, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          filters = _props.filters,
...
/***/ "./src/routes/Database/components/cards/Card.scss":
/***/ (function(module, exports, __webpack_require__) {
...
if(true) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("./node_modules/css-loader/index.js?{\"sourceMap\":true,\"minimize\":{\"autoprefixer\":{\"add\":true,\"remove\":true,\"browsers\":[\"last 2 versions\"]},\"discardComments\":{\"removeAll\":true},\"discardUnused\":false,\"mergeIdents\":false,\"reduceIdents\":false,\"safe\":true,\"sourcemap\":true}}!./node_modules/sass-loader/lib/loader.js?{\"sourceMap\":true,\"includePaths\":[\"E:/Documents/Github/GGD/src/styles\"]}!./src/routes/Database/components/cards/Card.scss", function() {
...
/***/ "./src/routes/Database/components/cards/card-back.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_prop_types__ = __webpack_require__("./node_modules/prop-types/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Card_scss__ = __webpack_require__("./src/routes/Database/components/cards/Card.scss");
...
var CardBack = function (_Component) {
  __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_inherits___default()(CardBack, _Component);

  function CardBack(props) {
    __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, CardBack);

    var _this = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_possibleConstructorReturn___default()(this, (CardBack.__proto__ || Object.getPrototypeOf(CardBack)).call(this, props));
  ...
  __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(CardBack, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          title = _props.title,
      ...
      return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
        __WEBPACK_IMPORTED_MODULE_7_material_ui__["t" /* Card */],
        { className: 'cardContainer' },
        __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
          __WEBPACK_IMPORTED_MODULE_7_material_ui__["u" /* CardContent */],
          null,
          __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
            'div',
            { className: 'header' },
            __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
              ...
              { type: 'Title', component: 'h4' },
              title
            )
          )
        ),
        __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
          __WEBPACK_IMPORTED_MODULE_7_material_ui__["v" /* CardActions */],
          { style: { flexDirection: 'column', flexWrap: 'wrap', minHeight: '52px', height: 'auto', alignItems: 'left' } },
          content && content.map(function (member) {
            return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
              'div',
              { style: { display: 'flex' } },
              __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                __WEBPACK_IMPORTED_MODULE_7_material_ui__["k" /* Button */],
                { target: '_blank', dense: true, color: 'primary' },
                member.fullName
              ),
              __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                __WEBPACK_IMPORTED_MODULE_7_material_ui__["k" /* Button */],
...
/* unused harmony default export */ var _unused_webpack_default_export = (CardBack);

/***/ }),

/***/ "./src/routes/Database/components/cards/card-front.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Card_scss__ = __webpack_require__("./src/routes/Database/components/cards/Card.scss");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Card_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__Card_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_utils_helpers__ = __webpack_require__("./src/utils/helpers.js");
...
var CardFront = function (_Component) {
  __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_inherits___default()(CardFront, _Component);

  function CardFront(props) {
    __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, CardFront);

    var _this = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_possibleConstructorReturn___default()(this, (CardFront.__proto__ || Object.getPrototypeOf(CardFront)).call(this, props));
  ...
  __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(CardFront, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          title = _props.title,
          ...
          image = _props.image,
          links1 = _props.links1,
          links2 = _props.links2,
          content = _props.content,
          footer = _props.footer,
          tags = _props.tags,
          view = _props.view,
          _props$hasImage = _props.hasImage,
          hasImage = _props$hasImage === undefined ? true : _props$hasImage;

      return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
        __WEBPACK_IMPORTED_MODULE_8_material_ui__["b" /* Paper */],
        { className: 'cardContainer' },
        __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
          'div',
          { className: 'header' },
          view === 'grid' ? __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
            'div',
            { className: 'logoGrid' },
            hasImage && __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div', {
              className: 'iconGrid',
            ...
            __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
              ...
              { className: 'title' },
              __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                __WEBPACK_IMPORTED_MODULE_8_material_ui__["h" /* Typography */],
                { type: 'Title', component: 'h4', style: { textAlign: 'left' } },
                title
              ),
              __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                __WEBPACK_IMPORTED_MODULE_8_material_ui__["h" /* Typography */],
                { type: 'caption', style: { textAlign: 'left', marginTop: '5px' } },
                description
              )
            )
          ) : __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
          'div',
          { className: view === 'list' ? 'socialList' : 'socialGrid' },
          links1 && links1.map(function (link) {
            return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
              __WEBPACK_IMPORTED_MODULE_8_material_ui__["k" /* Button */],
              { target: '_blank', disabled: !link.link, href: link.link, dense: true, color: 'primary' },
              __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_utils_helpers__["a" /* getMediaIcon */])(link.type)
            );
          }),
          links1 && links2 && links1.length !== 0 && links2.length !== 0 && __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span', { className: 'line' }),
          links2 && links2.map(function (link) {
            return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
              __WEBPACK_IMPORTED_MODULE_8_material_ui__["k" /* Button */],
              { target: '_blank', disabled: !link.link, href: link.link, dense: true, color: 'primary' },
              __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_utils_helpers__["a" /* getMediaIcon */])(link.type)
        ...
        __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
          'div',
          { className: view === 'list' ? 'contentList' : 'contentGrid' },
          content && content.map(function (item, index) {
            return item && __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
              'div',
              null,
              index !== 0 && __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span', { className: 'dot' }),
              __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                __WEBPACK_IMPORTED_MODULE_8_material_ui__["k" /* Button */],
                {
                  className: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_utils_helpers__["f" /* getColorCode */])(item.status) + ' ' + 'itemButton',
                  target: '_blank',
                  href: item.link,
                  disabled: !item.link,
                  dense: true
        ...
        __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
            ...
            tags && tags.map(function (t) {
              return t !== 'null' && __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8_material_ui__["l" /* Chip */], { className: 'tag', label: t });
            })
          ),
          __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
            'div',
            { className: 'otherInfo' },
            footer.map(function (f, index) {
              return f !== null && __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                __WEBPACK_IMPORTED_MODULE_8_material_ui__["h" /* Typography */],
                { type: 'body2', component: 'h2', style: { marginRight: '10px', marginLeft: '15px' } },
                f
              );
            })
          )
...
/***/ "./src/routes/Database/components/cards/cards.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_routes_Database_components__ = __webpack_require__("./src/routes/Database/components/index.js");
...
var Cards = function (_Component) {
  __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_inherits___default()(Cards, _Component);

  function Cards(props) {
    __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, Cards);

    var _this = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_possibleConstructorReturn___default()(this, (Cards.__proto__ || Object.getPrototypeOf(Cards)).call(this, props));

    _this.handleInfoButton = function (event, index, selectedItem) {
      _this.setState({
        openPopover: true,
  ...
  __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(Cards, [{
    key: 'render',
    value: function render() {
      var _this2 = this;
      ...
      return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
          __WEBPACK_IMPORTED_MODULE_11_material_ui__["s" /* Popover */],
          {
          ...
          __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_routes_Database_components__["e" /* Form */], { selectedItem: this.state.selectedItem, closePopover: this.closePopover })
        ),
        content && content.map(function (item, index) {
          return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
            'div',
            { className: view === 'list' ? 'btnandcardList' : 'btnandcardGrid' },
            __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
              __WEBPACK_IMPORTED_MODULE_11_material_ui__["k" /* Button */],
              { className: 'info',
                onClick: function onClick() {
                  return _this2.handleInfoButton(event, index, item);
                },
                ref: function ref(node) {
                  _this2.button[index] = node;
                } },
              __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_10_static_icons__["w" /* Info */], null)
            ),
            __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_routes_Database_components__["f" /* CardFront */], {
              view: view,
              title: item.name,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_prop_types__ = __webpack_require__("./node_modules/prop-types/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__dataLayout_scss__ = __webpack_require__("./src/routes/Database/components/data-layout/dataLayout.scss");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__dataLayout_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__dataLayout_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_lodash__ = __webpack_require__("./node_modules/lodash/lodash.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_react_dom__ = __webpack_require__("./node_modules/react-dom/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_react_dom___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_react_dom__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_react_infinite_scroller__ = __webpack_require__("./node_modules/react-infinite-scroller/index.js");
...
var DataLayout = function (_Component) {
  __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_inherits___default()(DataLayout, _Component);

  function DataLayout(props) {
    __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, DataLayout);

    var _this = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_possibleConstructorReturn___default()(this, (DataLayout.__proto__ || Object.getPrototypeOf(DataLayout)).call(this, props));

    _this.getData = function (type) {
      axios.get('/api/' + _this.props.route + '/' + type).then(function (res) {
    ...
    _this.loadMoreItems = function (page) {
  ...
  __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(DataLayout, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          filters = _props.filters,
      ...
      return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
        __WEBPACK_IMPORTED_MODULE_10_material_ui__["b" /* Paper */],
        { style: { height: '100%', padding: '20px 20px 80px' }, elevation: 2 },
        __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
          'div',
          { className: 'contentContainer', id: 'scrollContainer' },
          __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_routes_Database_components__["b" /* Filters */], {
            resetContent: this.resetContent,
            updateFilter: updateFilter,
            updateData: updateData,
            filters: filters
          ...
          __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
            'div',
            { className: view === 'list' ? 'containerList' : 'containerGrid' },
            __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
              __WEBPACK_IMPORTED_MODULE_11_react_infinite_scroller___default.a,
              {
                pageStart: 0,
                loadMore: this.loadMoreItems,
                hasMore: !this.state.endOfContent,
                loader: __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_10_material_ui__["i" /* CircularProgress */], { className: 'contentLoader', size: 50, thickness: 8 })
              },
              view === 'table' ? __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_routes_Database_components__["c" /* Table */], {
                content: this.state.contentToLoad,
                category: filters.main
              }) : __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_routes_Database_components__["d" /* Cards */], {
                content: this.state.contentToLoad,
                view: view,
                filters: filters
              })
...
/***/ "./src/routes/Database/components/data-layout/dataLayout.scss":
/***/ (function(module, exports, __webpack_require__) {
...
if(true) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("./node_modules/css-loader/index.js?{\"sourceMap\":true,\"minimize\":{\"autoprefixer\":{\"add\":true,\"remove\":true,\"browsers\":[\"last 2 versions\"]},\"discardComments\":{\"removeAll\":true},\"discardUnused\":false,\"mergeIdents\":false,\"reduceIdents\":false,\"safe\":true,\"sourcemap\":true}}!./node_modules/sass-loader/lib/loader.js?{\"sourceMap\":true,\"includePaths\":[\"E:/Documents/Github/GGD/src/styles\"]}!./src/routes/Database/components/data-layout/dataLayout.scss", function() {
			var newContent = __webpack_require__("./node_modules/css-loader/index.js?{\"sourceMap\":true,\"minimize\":{\"autoprefixer\":{\"add\":true,\"remove\":true,\"browsers\":[\"last 2 versions\"]},\"discardComments\":{\"removeAll\":true},\"discardUnused\":false,\"mergeIdents\":false,\"reduceIdents\":false,\"safe\":true,\"sourcemap\":true}}!./node_modules/sass-loader/lib/loader.js?{\"sourceMap\":true,\"includePaths\":[\"E:/Documents/Github/GGD/src/styles\"]}!./src/routes/Database/components/data-layout/dataLayout.scss");
			if(typeof newContent === 'string') newContent = [[module.i, newContent, '']];
			update(newContent);
		});
...
/***/ "./src/routes/Database/components/filters/filters.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_prop_types__ = __webpack_require__("./node_modules/prop-types/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__filters_scss__ = __webpack_require__("./src/routes/Database/components/filters/filters.scss");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__filters_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__filters_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_lodash__ = __webpack_require__("./node_modules/lodash/lodash.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_static_icons__ = __webpack_require__("./src/static/icons/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_utils_helpers__ = __webpack_require__("./src/utils/helpers.js");
...
var Filters = function (_Component) {
  __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_inherits___default()(Filters, _Component);

  function Filters(props) {
    __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, Filters);

    var _this = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_possibleConstructorReturn___default()(this, (Filters.__proto__ || Object.getPrototypeOf(Filters)).call(this, props));
    ...
    _this.transformData = function (mainCategory) {
      ...
      _this.props.updateFilter(mainCategory, subcategory, filterValues ? filterValues.split(',') : []);
    ...
    _this.onSearch = function (name, value) {
      _this.setState({
        searchText: value
      });
      _this.props.updateData(name, value);
      _this.props.resetContent();
    };

    _this.onEnter = function (event) {
      if (event.key === 'Enter') {
        _this.props.updateData(_this.props.filters.main, _this.state.searchText);
        _this.props.resetContent();
      }
    };

    _this.clearSearchText = function (name) {
      _this.setState({
        searchText: ''
      });
  ...
  __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(Filters, [{
    key: 'render',
    value: function render() {
      var _this2 = this;
      ...
      return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
          'div',
          { className: 'filtersToolbar' },
          __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
            'div',
            { className: 'mainFilters' },
            sortByOptions.map(function (o) {
              return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_12_material_ui__["l" /* Chip */], { className: 'chip', label: 'sort by ' + o, onClick: function onClick() {
                  return _this2.transformData(o);
                } });
            })
          ),
          __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
            __WEBPACK_IMPORTED_MODULE_12_material_ui__["m" /* FormControl */],
            { className: 'searchBar' },
            __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_12_material_ui__["n" /* Input */], {
              id: 'searchBar',
              type: 'text',
              ...
              endAdornment: __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                __WEBPACK_IMPORTED_MODULE_12_material_ui__["o" /* InputAdornment */],
                { position: 'end' },
                this.state.searchText && __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                  __WEBPACK_IMPORTED_MODULE_12_material_ui__["p" /* IconButton */],
                  {
                    style: { height: '25px', width: '25px' },
                    onClick: function onClick() {
                      return _this2.clearSearchText(filters.main);
                    } },
                  __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13_material_ui_icons__["e" /* Clear */], null)
                )
              )
            }),
            __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
              __WEBPACK_IMPORTED_MODULE_12_material_ui__["p" /* IconButton */],
              {
                ...
                onClick: function onClick() {
                  return _this2.onSearch(filters.main, _this2.state.searchText);
                } },
              __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13_material_ui_icons__["f" /* Search */], null)
            )
          ),
          __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
            __WEBPACK_IMPORTED_MODULE_12_material_ui__["q" /* Tooltip */],
            {
              ...
              placement: 'top' },
            __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
              __WEBPACK_IMPORTED_MODULE_12_material_ui__["k" /* Button */],
              {
                raised: true,
                style: { minWidth: '50px', padding: 0 },
                onClick: this.handleViewChange
              },
              __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9_utils_helpers__["d" /* getViewIcon */])(view)
            )
          )
        ),
        __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
            __WEBPACK_IMPORTED_MODULE_12_material_ui__["q" /* Tooltip */],
            { style: { width: '100%', display: 'flex', justifyContent: 'flex-start' }, id: 'tooltip-icon', title: 'Open filters', placement: 'top' },
            __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
              __WEBPACK_IMPORTED_MODULE_12_material_ui__["k" /* Button */],
              {
        ...
        __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
          __WEBPACK_IMPORTED_MODULE_12_material_ui__["r" /* Drawer */],
          {
            anchor: 'top',
            type: 'persistent',
          ...
          __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
              ...
              __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9_utils_helpers__["e" /* getFilters */])(filters.main).map(function (f) {
                return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                  'div',
                  { className: 'multiselect' },
                  __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_10_react_select__["a" /* default */], {
                    closeOnSelect: true,
                    multi: true,
                    onChange: function onChange(value) {
                      _this2.transformData(filters.main, f.filterValue, value);
                    },
                    options: f.filterOptions,
                    placeholder: f.filterName,
                    removeSelected: _this2.state.removeSelected
                    //    rtl={this.state.rtl}
                    , simpleValue: true,
        ...
        __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
            __WEBPACK_IMPORTED_MODULE_12_material_ui__["q" /* Tooltip */],
            { id: 'tooltip-icon3', title: 'Return to top', placement: 'top' },
            __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
              __WEBPACK_IMPORTED_MODULE_12_material_ui__["k" /* Button */],
              { raised: true, onClick: function onClick() {
                  return window.scrollTo(0, 0);
                }, style: { margin: '0 10px', minWidth: '32px', padding: 0 } },
              __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8_static_icons__["x" /* BackToTop */], null)
            )
          )
        )
      );
...
/***/ "./src/routes/Database/components/filters/filters.scss":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./src/routes/Database/components/forms/form.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__form_scss__ = __webpack_require__("./src/routes/Database/components/forms/form.scss");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__form_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__form_scss__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_material_ui__ = __webpack_require__("./node_modules/material-ui/index.es.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_material_ui_icons__ = __webpack_require__("./node_modules/material-ui-icons/index.es.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_react_google_recaptcha__ = __webpack_require__("./node_modules/react-google-recaptcha/lib/recaptcha-wrapper.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_react_google_recaptcha___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11_react_google_recaptcha__);
...
var Form = function (_Component) {
  ...
  function Form(props) {
    ...
    _this.componentWillMount = function () {
      ...
      _this.setState({
        formItem: _this.props.selectedItem,
        hasSubmitted: false,
        success: false
      });
    };
    ...
    _this.handleFormChange = function (name) {
      return function (event) {
        _this.setState({
          formItem: Object.assign({}, _this.state.formItem, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()({}, name, event.target.value))
        });
      };
    };
    ...
    _this.sendMail = function () {
      ...
      xhttp.open('GET', '/send?' + 'title=' + _this.state.formItem.name + '&comment=' + _this.state.formItem.comment + '&mail=' + _this.state.formItem.mail + '&verification=' + _this.state['verification'], true);
      xhttp.send();
    };
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement(
        ...
        this.state.isLoading ? __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement(
          'div',
          { className: 'popupStatus', style: { backgroundColor: 'white' } },
          __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_material_ui__["i" /* CircularProgress */], { size: 80 })
        ) : this.state.success ? __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement(
          'div',
          { className: 'popupStatus', style: { backgroundColor: '#70d188' } },
          __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_10_material_ui_icons__["c" /* CheckCircle */], { style: { width: '50px', height: '50px' } }),
          __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement(
            __WEBPACK_IMPORTED_MODULE_9_material_ui__["h" /* Typography */],
            { type: 'headline', component: 'h4' },
            'Thank you!'
          )
        ) : this.state.hasSubmitted ? __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement(
          'div',
          { className: 'popupStatus', style: { backgroundColor: '#db8787' } },
          __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_10_material_ui_icons__["d" /* Error */], { style: { width: '50px', height: '50px' } }),
          __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement(
            __WEBPACK_IMPORTED_MODULE_9_material_ui__["h" /* Typography */],
            { type: 'headline', component: 'h4' },
            'Email not sent :('
        ...
        __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement(
          'form',
          {
            className: 'infoForm',
            autoComplete: 'off' },
          __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_material_ui__["j" /* TextField */], {
            id: 'name',
            name: 'name',
            style: { width: '100%' },
          ...
          __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_react_google_recaptcha___default.a, {
            ref: 'recaptcha',
          ...
          __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement(
            __WEBPACK_IMPORTED_MODULE_9_material_ui__["k" /* Button */],
            {
              style: { width: '50px', margin: '20px', alignSelf: 'flex-end' },
              raised: true,
              onClick: this.sendMail,
              disabled: !this.state.formItem.comment || !this.state.formItem.mail || this.state.hasSubmitted || !this.state['verification'] },
            'Send!'
          )
        )
      );
...
Form.propTypes = {
  selectedItem: __WEBPACK_IMPORTED_MODULE_6_prop_types___default.a.object.isRequired
};
...
/***/ "./src/routes/Database/components/forms/form.scss":
/***/ (function(module, exports, __webpack_require__) {
...
if(true) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("./node_modules/css-loader/index.js?{\"sourceMap\":true,\"minimize\":{\"autoprefixer\":{\"add\":true,\"remove\":true,\"browsers\":[\"last 2 versions\"]},\"discardComments\":{\"removeAll\":true},\"discardUnused\":false,\"mergeIdents\":false,\"reduceIdents\":false,\"safe\":true,\"sourcemap\":true}}!./node_modules/sass-loader/lib/loader.js?{\"sourceMap\":true,\"includePaths\":[\"E:/Documents/Github/GGD/src/styles\"]}!./src/routes/Database/components/forms/form.scss", function() {
			var newContent = __webpack_require__("./node_modules/css-loader/index.js?{\"sourceMap\":true,\"minimize\":{\"autoprefixer\":{\"add\":true,\"remove\":true,\"browsers\":[\"last 2 versions\"]},\"discardComments\":{\"removeAll\":true},\"discardUnused\":false,\"mergeIdents\":false,\"reduceIdents\":false,\"safe\":true,\"sourcemap\":true}}!./node_modules/sass-loader/lib/loader.js?{\"sourceMap\":true,\"includePaths\":[\"E:/Documents/Github/GGD/src/styles\"]}!./src/routes/Database/components/forms/form.scss");
			if(typeof newContent === 'string') newContent = [[module.i, newContent, '']];
			update(newContent);
		});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__cards_card_front__ = __webpack_require__("./src/routes/Database/components/cards/card-front.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cards_card_back__ = __webpack_require__("./src/routes/Database/components/cards/card-back.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cards_cards__ = __webpack_require__("./src/routes/Database/components/cards/cards.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__filters_filters__ = __webpack_require__("./src/routes/Database/components/filters/filters.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__forms_form__ = __webpack_require__("./src/routes/Database/components/forms/form.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__table_table__ = __webpack_require__("./src/routes/Database/components/table/table.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__data_layout_dataLayout__ = __webpack_require__("./src/routes/Database/components/data-layout/dataLayout.js");
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return __WEBPACK_IMPORTED_MODULE_0__cards_card_front__["a"]; });
/* unused harmony reexport CardBack */
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_6__data_layout_dataLayout__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_2__cards_cards__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_3__filters_filters__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return __WEBPACK_IMPORTED_MODULE_4__forms_form__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_5__table_table__["a"]; });
...
/***/ "./src/routes/Database/components/table/table.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_prop_types__ = __webpack_require__("./node_modules/prop-types/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__table_scss__ = __webpack_require__("./src/routes/Database/components/table/table.scss");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__table_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__table_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_lodash__ = __webpack_require__("./node_modules/lodash/lodash.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_material_ui__ = __webpack_require__("./node_modules/material-ui/index.es.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_utils_helpers__ = __webpack_require__("./src/utils/helpers.js");
...
var Table = function (_Component) {
  __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_inherits___default()(Table, _Component);

  function Table(props) {
    __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, Table);

    var _this = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_possibleConstructorReturn___default()(this, (Table.__proto__ || Object.getPrototypeOf(Table)).call(this, props));

    _this.state = {};
    return _this;
  }

  __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(Table, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          content = _props.content,
      ...
      return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
          __WEBPACK_IMPORTED_MODULE_8_material_ui__["c" /* Table */],
          null,
          __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
            __WEBPACK_IMPORTED_MODULE_8_material_ui__["d" /* TableHead */],
            null,
            __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
              __WEBPACK_IMPORTED_MODULE_8_material_ui__["e" /* TableRow */],
              null,
              __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9_utils_helpers__["b" /* getTableHeader */])(category).map(function (h) {
                return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                  __WEBPACK_IMPORTED_MODULE_8_material_ui__["f" /* TableCell */],
                  { padding: 'dense' },
                  h
                );
              })
          ...
          __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
            __WEBPACK_IMPORTED_MODULE_8_material_ui__["g" /* TableBody */],
            null,
            content && content.map(function (item, index) {
              return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                __WEBPACK_IMPORTED_MODULE_8_material_ui__["e" /* TableRow */],
                    ...
                    item.links1.map(function (m) {
                      return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                        'a',
                        {
                          ...
                          style: { marginRight: '10px' },
                          href: m.link },
                        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9_utils_helpers__["c" /* transformName */])(m.type) || m.type
                      );
                    })
                  )
                ),
                item.links2 && __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                  __WEBPACK_IMPORTED_MODULE_8_material_ui__["f" /* TableCell */],
                  { padding: 'dense' },
                  __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                    'div',
                    { className: 'flexClass' },
                    item.links2.map(function (p) {
                      return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                        'a',
                        {
                          target: '_blank',
                          style: { marginRight: '10px' },
                          href: p.link },
                        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9_utils_helpers__["c" /* transformName */])(p.type) || p.type
                      );
                    })
                  )
                ),
...
Table.propTypes = {
  content: __WEBPACK_IMPORTED_MODULE_5_prop_types___default.a.object.isRequired,
  category: __WEBPACK_IMPORTED_MODULE_5_prop_types___default.a.string.isRequired
};
...
/***/ "./src/routes/Database/components/table/table.scss":
/***/ (function(module, exports, __webpack_require__) {
...
if(true) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("./node_modules/css-loader/index.js?{\"sourceMap\":true,\"minimize\":{\"autoprefixer\":{\"add\":true,\"remove\":true,\"browsers\":[\"last 2 versions\"]},\"discardComments\":{\"removeAll\":true},\"discardUnused\":false,\"mergeIdents\":false,\"reduceIdents\":false,\"safe\":true,\"sourcemap\":true}}!./node_modules/sass-loader/lib/loader.js?{\"sourceMap\":true,\"includePaths\":[\"E:/Documents/Github/GGD/src/styles\"]}!./src/routes/Database/components/table/table.scss", function() {
			var newContent = __webpack_require__("./node_modules/css-loader/index.js?{\"sourceMap\":true,\"minimize\":{\"autoprefixer\":{\"add\":true,\"remove\":true,\"browsers\":[\"last 2 versions\"]},\"discardComments\":{\"removeAll\":true},\"discardUnused\":false,\"mergeIdents\":false,\"reduceIdents\":false,\"safe\":true,\"sourcemap\":true}}!./node_modules/sass-loader/lib/loader.js?{\"sourceMap\":true,\"includePaths\":[\"E:/Documents/Github/GGD/src/styles\"]}!./src/routes/Database/components/table/table.scss");
			if(typeof newContent === 'string') newContent = [[module.i, newContent, '']];
			update(newContent);
		});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__VideoGames_components_VideoGames__ = __webpack_require__("./src/routes/Database/VideoGames/components/VideoGames.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Tools_components_Tools__ = __webpack_require__("./src/routes/Database/Tools/components/Tools.js");
...
var VideoGamesC = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_react_redux__["connect"])(mapStateToProps, mapDispatchToProps)(__WEBPACK_IMPORTED_MODULE_2__VideoGames_components_VideoGames__["a" /* default */]);
var ToolsC = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_react_redux__["connect"])(mapStateToProps, mapDispatchToProps)(__WEBPACK_IMPORTED_MODULE_3__Tools_components_Tools__["a" /* default */]);
...
function updateData(sortBy, value) {
  return {
    type: UPDATE_DATA,
    payload: { sortBy: sortBy, value: value }
  };
}
function updateFilter(category) {
  ...
  return {
    type: UPDATE_FILTER,
    payload: { category: category, subcategory: subcategory, value: value }
  };
}
...
// Action Handlers
// ------------------------------------
var ACTION_HANDLERS = (_ACTION_HANDLERS = {}, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ACTION_HANDLERS, UPDATE_FILTER, function (state, action) {
  return action.payload.subcategory ? Object.assign({}, state, {
    filters: Object.assign({}, state.filters, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()({
      main: action.payload.category || state.filters.main
    }, action.payload.category, Object.assign({}, state.filters[action.payload.category], __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()({}, action.payload.subcategory, action.payload.value || state.filters[action.payload.category][action.payload.subcategory]))))
  }) : Object.assign({}, state, {
    filters: Object.assign({}, state.filters, {
      main: action.payload.category || state.filters.main
    })
  });
}), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ACTION_HANDLERS, RESET_FILTERS, function (state, action) {
  return Object.assign({}, state, {
    filters: Object.assign({}, state.filters, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()({}, action.payload.category, initialState.filters[action.payload.category])),
    currentData: state.data[action.payload.category]
  });
}), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ACTION_HANDLERS, CHANGE_VIEW, function (state, action) {
  return Object.assign({}, state, {
    view: action.payload.view
  });
}), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ACTION_HANDLERS, UPDATE_DATA, function (state, action) {
  return Object.assign({}, state, {
    currentData: state.data[action.payload.sortBy].filter(function (d) {
      return __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.difference(__WEBPACK_IMPORTED_MODULE_1_lodash___default.a.flattenDeep(Object.values(state.filters[action.payload.sortBy])), d.tags).length === 0;
    }).filter(function (d) {
      return d.name.toLowerCase().includes(action.payload.value);
    })
  });
}), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ACTION_HANDLERS, INITIAL_DATA, function (state, action) {
  return Object.assign({}, state, {
    data: Object.assign({}, state.data, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()({}, action.payload.type, action.payload.data)),
    currentData: state.filters.main === action.payload.type ? action.payload.data : state.currentData
  });
}), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_ACTION_HANDLERS, INITIAL_STATE, function (state, action) {
  return initialState;
}), _ACTION_HANDLERS);
